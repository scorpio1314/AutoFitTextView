...
import com.huazhitech.sudoku.game.SudokuGame.OnPuzzleSolvedListener;
import com.huazhitech.sudoku.gui.inputmethod.IMControlPanel;
import com.huazhitech.sudoku.gui.inputmethod.IMControlPanelStatePersister;
import com.huazhitech.sudoku.gui.inputmethod.IMNumpad;
import com.huazhitech.sudoku.gui.inputmethod.IMPopup;
import com.huazhitech.sudoku.gui.inputmethod.IMSingleNumber;
import com.huazhitech.sudoku.utils.AndroidUtils;

/*
 */
public class SudokuPlayActivity extends Activity implements InterstitialAdListener {
	private final String LOG_TAG = "SudokuPlayActivity";
...
//		}
	...
	public void showAd() {
		ad = new InterstitialAd(this,"adba51a2ce8d4bf88232496bf61215a8",false,this);
		// 设置全屏格式
